...
## 👨‍💻 About Me
I'm a .NET Developer focused on building practical backend applications, APIs, and maintainable software solutions.
I mainly work with C#, .NET, ASP.NET Core, and SQL, with additional experience in Python and JavaScript. I enjoy turning requirements into working features, solving practical problems, integrating external services, and improving existing systems.
I value clean code, maintainability, clear communication, and pragmatic engineering.
...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Entity%20Framework%20Core-512BD4?logo=dotnet&logoColor=white" alt="Entity Framework Core"/>
  <img src="https://img.shields.io/badge/REST%20API-009688?logo=fastapi&logoColor=white" alt="REST API"/>
